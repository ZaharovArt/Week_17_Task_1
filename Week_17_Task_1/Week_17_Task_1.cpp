// Week_17_Task_1.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы
...
int main()
{
    ...
    Array3 = AddColumArray(Array1, rows, cols, Array2, position-1);
